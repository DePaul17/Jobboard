<x-app-layout>
  ...
  <body>
    <div class="card">
      <div class="card-body">
        <h3 class="card-title text-center">Update offer</h3>
        <hr>
        <form method="post" action="{{ url('/update/' . $resource->id) }}">
          @csrf
          @method('PUT')
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="advertisement" name="advertisements" value="{{ $resource->advertisements }}" required>
          </div>
          <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <textarea  class="form-control" name="description" id="description" cols="31" rows="5" required> {{ $resource->description }} </textarea>
            <!-- <input type="text" class="form-control" id="description" name="description" value="{{ $resource->description }}" required> -->
          </div>
          <div class="mb-3">
              <label for="date" class="form-label">Date</label>
              <input type="date" class="form-control" id="date_pub" name="date_pub" value="{{ $resource->date_pub }}" required>
          </div>
